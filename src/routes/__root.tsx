    ...
    head: () => {
        ...
        return {
            ...
            links: [
                ...
                {
                    rel: 'shortcut icon',
                    href: '/favicon.ico?v=20260713b',
                    type: 'image/x-icon',
                    sizes: '16x16 24x24 32x32 48x48 64x64',
                },
                { rel: 'icon', href: '/favicon-16x16.png?v=20260713b', type: 'image/png', sizes: '16x16' },
                { rel: 'icon', href: '/favicon-32x32.png?v=20260713b', type: 'image/png', sizes: '32x32' },
                { rel: 'icon', href: '/favicon.svg?v=20260713b', type: 'image/svg+xml', sizes: 'any' },
                { rel: 'apple-touch-icon', href: '/apple-touch-icon.png?v=20260713b', sizes: '180x180' },
                { rel: 'manifest', href: '/manifest.json?v=20260713b' },
